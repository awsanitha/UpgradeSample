...
namespace eShopLegacyMVC.Models.Infrastructure
{
    public class CatalogDBInitializer
    {
        ...
        public CatalogDBInitializer(CatalogItemHiLoGenerator indexGenerator, IConfiguration configuration, string contentRootPath)
        {
        ...
        static IEnumerable<CatalogBrand> GetCatalogBrandsFromFile(string contentRootPath = "")
        {
            ...
            var csvheaders = GetHeaders(csvFileCatalogBrands, requiredHeaders);
